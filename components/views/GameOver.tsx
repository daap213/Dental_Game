...
export const GameOver: React.FC<GameOverProps> = ({ score, message, onRestart, onQuit, lang }) => {
  ...
  return (
    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-red-950 text-white p-8 animate-in fade-in duration-500">
      ...
      <h1 className="text-5xl font-bold mb-2 text-red-500 tracking-widest uppercase text-center">{t.title}</h1>
      <h2 className="text-2xl mb-8 text-red-300 text-center">{t.subtitle}</h2>
