...
export const TEXT = {
    en: {
        menu: {
            ...
            select_aim: "Select Aiming Style",
            mouse_aim: "MOUSE AIM",
            keyboard_aim: "KEYBOARD ONLY",
            select_loadout: "Select Loadout",
            loadout_all: "Enemies drop all weapon types.",
            loadout_specific: "Enemies ONLY drop upgrade for selected weapon + Health.",
    ...
    es: {
        menu: {
            ...
            loadout_specific: "Solo sueltan mejoras del arma elegida + Salud.",
