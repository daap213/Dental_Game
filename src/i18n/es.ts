...
export const es: Dictionary = {
  ...
  settings: {
    ...
    tab_audio: 'AUDIO Y DATOS',
    nickname: 'Apodo',
    nickname_placeholder: 'NOVATO',
    nickname_hint: 'Se queda en este dispositivo. No pongas tu nombre real.',
    language: 'Idioma',
    rebind: 'Pulsa una tecla…',
    rebind_cancel: 'Escape cancela',
    change: 'CAMBIAR',
    reset: 'RESTABLECER',
    conflict: 'Ya la usa',
    fixed_title: 'FIJOS',
    fixed_shoot: 'Apuntar y disparar',
    fixed_dash: 'Impulso',
    fixed_pause: 'Pausa',
    mouse_left: 'CLIC IZQ.',
    ...
    music: 'Música',
    sfx: 'Efectos',
    data_title: 'TUS DATOS',
    data_desc: 'Los ajustes y las puntuaciones se guardan en este navegador y en ningún otro sitio.',
    erase: 'BORRAR MIS DATOS',
    erase_title: '¿Borrar todo?',
    erase_warning:
      'Se borran tus ajustes, tus teclas y todas las puntuaciones. No se puede deshacer.',
    cancel: 'CANCELAR',
    confirm: 'BORRAR',
  },
  records: {
    ...
    btn: 'RÉCORDS',
    close: 'CERRAR',
    empty: 'Aún no hay partidas. La tabla se llena sola.',
    col_date: 'Fecha',
    col_name: 'Nombre',
    col_score: 'Puntos',
    col_class: 'Clase',
    ...
    col_kills: 'Bajas',
    col_time: 'Tiempo',
    outcome_victory: 'COMPLETADA',
    outcome_defeat: 'CAÍDA',
    ask_title: 'Escribe tu nombre',
    ask_desc: 'Solo esta vez. Puedes cambiarlo después en ajustes.',
    submit: 'GUARDAR',
    skip: 'SALTAR',
    your_run: 'ESTA PARTIDA',
    privacy_link: 'Cómo se guarda esto',
  },
  legal: {
    title: 'LEGAL',
    close: 'CERRAR',
